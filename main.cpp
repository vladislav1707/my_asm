// TODO: надо определится откуда читать, надо читать из файла в нужной директории с нужным именем(у файла)
// TODO: думаю через терминал с помощью аргументов

// TODO: надо удалить комментарии(после #), но так чтобы текст в исходном файле не менялся, а только программа читала без комментариев

// TODO: надо прочитать все label, записать в вектор номер команды на которую ведет label, удалить все label,
// TODO: и заменить на номер строки

// TODO: надо записать все в двухмерный список, и вот так будет выглядеть в конце:
// TODO: [[команда, аргумент], [команда], [команда, аргумент, аргумент]]

// TODO: надо сделать обработку констант, их обработка будет похожа на обработку меток, но вместо label будет const, и второй аргумент
// TODO: будет выбирать значение константы вместо того чтобы опираться на ее положение(как это будет/сделано у меток)
